...
\cvitem Program committees: ICFP '24, Haskell Implementors' Workshop '19,
...
Modeling, and Design (FARM), November 2014--present
...
\section*{Submitted}
\cvitem Brent A. Yorgey. Disco: A Functional Programming Language for
Discrete Mathematics.  Submitted to \emph{Proceedings of the 12th
Internationl Workshop on Trends in Functional Programming in Education}
(TFPIE '23).
