...
\cvitem Dan Piponi and Brent A. Yorgey. Polynomial Functors
  Constrained by Regular Expressions (submitted to MPC 2015). \\
  Forming polymorphic data types with restrictions, using a
...
% \cvitem \emph{Building Domain-Specific Languages and Tools}. Hendrix
% College. XXX date.
% \cvitem \emph{Building Domain-Specific Languages and Tools}. Grinnell
% College. XXX date.
